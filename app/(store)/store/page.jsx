    ...
    return (
        <>
            ...
            <Paper bg="gold" p="0.2rem 0.8rem" mb="-0.4rem" w="fit-content" pos="relative" style={{ zIndex: 2 }}>
                <Title fz="1.2rem" c="#000" order={2}>{t('featuredPackages')}</Title>
            </Paper>
            <Carousel
                slideGap="1rem"
                h={365}
            ...
            <Paper bg="gold" p="0.2rem 0.8rem" mb="-0.4rem" w="fit-content" pos="relative" style={{ zIndex: 2 }}>
                <Title fz="1.2rem" c="#000" order={2}>{t('recentPurchases')}</Title>
            </Paper>
            <Carousel
                mb="1rem"
                slideGap="1rem"
            ...
            <Paper p="2rem">
                <Title c="bright" mb="1rem">{t('welcome', { server_name: settings.server_name })}</Title>
                <Text mb="2rem" size="lg">{t('description', { server_name: settings.server_name })}</Text>
