            ...
            <Paper pt="2rem" p="1rem" pos="relative">
                <Tooltip label={t('backToBlog')}>
                    <Anchor pos="absolute" left="1rem" top="-1rem" component={Link} td="none" href="/blog">
                        <ActionIcon size="lg" color="primary" c="bright">
                            <TbChevronLeft size="1.2rem" color="#000" />
                        </ActionIcon>
                    </Anchor>
                </Tooltip>
                <Group justify="space-between">
                    <Group mb="1rem">
                        ...
                        />
                        <div>
                            <Text c="bright" size="xl" mb="-0.2rem" fw={500}>{blog.primary_author.name}</Text>
                            <Text fz="md" c="dimmed">
                ...
                <Box mb="1rem">
                    {blog.tags.map(tag => (
                        <Badge radius={4} key={tag.name} variant="light" color="primary">{tag.name}</Badge>
                    ))}
                </Box>
